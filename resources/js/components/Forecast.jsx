...
const FRONTEND_WEATHERBIT_API_KEY = '12358484'
...
async function fetchDirectFromWeatherbit(city) {
  ...
  const url = `https://api.weatherbit.io/v2.0/forecast/daily?city=${encodeURIComponent(c)},AU&days=5&key=${encodeURIComponent(FRONTEND_WEATHERBIT_API_KEY)}`
